...
- Dataset digest: `sha256:d5190c54efeba375f4fd925eca14bac78b8b6d174055db5243f29af1775c9480` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
|---|---:|---:|
| Overall | 46% → 78% (+32 points) | 49% → 78% (+29 points) |
| Security | 100% → 100% (±0 points) | 95% → 100% (+5 points) |
| Correctness | 30% → 64% (+34 points) | 29% → 60% (+31 points) |
| Discoverability | 32% → 89% (+57 points) | 48% → 89% (+41 points) |
| Effectiveness | 40% → 52% (+12 points) | 39% → 47% (+8 points) |
| Efficiency | 27% → 87% (+60 points) | 32% → 94% (+62 points) |
